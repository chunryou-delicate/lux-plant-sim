...
| 여캐 | 상의 | `yeoja_top19_purplecardi_rigged.glb` | 6,793 |
| 여캐 | 상의 | `yeoja_top20_orangehoodie_rigged.glb` | 6,640 |
| 여캐 | 상의 | `yeoja_top21_peacoat_rigged.glb` | 4,612 |
...
| 여캐 | 하의 | `yeoja_bottom15_plaidskirt_rigged.glb` | 5,136 |
| 여캐 | 하의 | `yeoja_bottom16_sweatpants_rigged.glb` | 3,323 |
| 여캐 | 하의 | `yeoja_bottom17_grayskirt_rigged.glb` | 3,190 |
...
| 여캐 | 신발 | `yeoja_shoes21_loafers2_rigged.glb` | 3,481 |
| 여캐 | 신발 | `yeoja_shoes22_blueslippers_rigged.glb` | 2,790 |
| 여캐 | 신발 | `yeoja_shoes23_laceboots_rigged.glb` | 3,588 |
...
| 여캐 | 세트 | `yeoja_set1_pajama_rigged.glb` | 6,049 |
...
| 여캐 | 몸(옷 밑 지움) | `yeoja_body_v19_under_biker.glb` | 7,057 |
| 여캐 | 몸(옷 밑 지움) | `yeoja_body_v19_under_dress1.glb` | 7,057 |
| 여캐 | 몸(옷 밑 지움) | `yeoja_body_v19_under_garden.glb` | 7,057 |
| 여캐 | 몸(옷 밑 지움) | `yeoja_body_v19_under_hoodiedress.glb` | 7,057 |
| 여캐 | 몸(옷 밑 지움) | `yeoja_body_v19_under_knitdress.glb` | 7,057 |
| 여캐 | 몸(옷 밑 지움) | `yeoja_body_v19_under_labcoat.glb` | 7,057 |
| 여캐 | 몸(옷 밑 지움) | `yeoja_body_v19_under_orangehoodie.glb` | 7,057 |
| 여캐 | 몸(옷 밑 지움) | `yeoja_body_v19_under_outfit2.glb` | 7,057 |
| 여캐 | 몸(옷 밑 지움) | `yeoja_body_v19_under_outfit3.glb` | 7,057 |
| 여캐 | 몸(옷 밑 지움) | `yeoja_body_v19_under_outfit4.glb` | 7,057 |
| 여캐 | 몸(옷 밑 지움) | `yeoja_body_v19_under_outfit5.glb` | 7,057 |
| 여캐 | 몸(옷 밑 지움) | `yeoja_body_v19_under_overalls.glb` | 7,057 |
| 여캐 | 몸(옷 밑 지움) | `yeoja_body_v19_under_pajama.glb` | 7,057 |
| 여캐 | 몸(옷 밑 지움) | `yeoja_body_v19_under_parka.glb` | 7,057 |
| 여캐 | 몸(옷 밑 지움) | `yeoja_body_v19_under_peacoat.glb` | 7,057 |
| 여캐 | 몸(옷 밑 지움) | `yeoja_body_v19_under_plaid.glb` | 7,057 |
| 여캐 | 몸(옷 밑 지움) | `yeoja_body_v19_under_puffer.glb` | 7,057 |
| 여캐 | 몸(옷 밑 지움) | `yeoja_body_v19_under_raincoat.glb` | 7,057 |
| 여캐 | 몸(옷 밑 지움) | `yeoja_body_v19_under_sailor.glb` | 7,057 |
| 여캐 | 몸(옷 밑 지움) | `yeoja_body_v19_under_shirt1.glb` | 7,057 |
| 여캐 | 몸(옷 밑 지움) | `yeoja_body_v19_under_summer.glb` | 7,057 |
| 여캐 | 몸(옷 밑 지움) | `yeoja_body_v19_under_sundress.glb` | 7,057 |
| 여캐 | 몸(옷 밑 지움) | `yeoja_body_v19_under_track.glb` | 7,057 |
| 여캐 | 몸(옷 밑 지움) | `yeoja_body_v19_under_turtle.glb` | 7,057 |
...
| 남캐 | 상의 | `namja_top21_trench_rigged.glb` | 5,231 |
| 남캐 | 상의 | `namja_top22_utility_rigged.glb` | 6,195 |
| 남캐 | 상의 | `namja_top23_yellowhoodie_rigged.glb` | 4,488 |
| 남캐 | 상의 | `namja_top24_burgundyknit_rigged.glb` | 9,044 |
...
| 남캐 | 하의 | `namja_bottom16_jeans3_rigged.glb` | 2,948 |
| 남캐 | 하의 | `namja_bottom17_cargo_rigged.glb` | 4,973 |
| 남캐 | 하의 | `namja_bottom18_bluejeans_rigged.glb` | 3,273 |
| 남캐 | 하의 | `namja_bottom19_charcoal_rigged.glb` | 4,621 |
...
| 남캐 | 신발 | `namja_shoes17_white2_rigged.glb` | 2,088 |
| 남캐 | 신발 | `namja_shoes18_hiking_rigged.glb` | 4,044 |
| 남캐 | 신발 | `namja_shoes19_whitesneak_rigged.glb` | 2,692 |
| 남캐 | 신발 | `namja_shoes1_sneakers_rigged.glb` | 2,497 |
| 남캐 | 신발 | `namja_shoes20_brownboots_rigged.glb` | 3,441 |
...
| 남캐 | 세트 | `namja_set1_sweater_rigged.glb` | 10,370 |
| 남캐 | 세트 | `namja_set2_suit_rigged.glb` | 5,379 |
| 남캐 | 소품 | `namja_acc1_apron_rigged.glb` | 4,391 |
| 남캐 | 모자 | `namja_hat1_cap_rigged.glb` | 4,058 |
| 남캐 | 눈 | `namja_face_eyes1.glb` | 298 |
| 남캐 | 몸(옷 밑 지움) | `namja_body_v19_under_burgundy.glb` | 9,986 |
| 남캐 | 몸(옷 밑 지움) | `namja_body_v19_under_camp.glb` | 9,986 |
| 남캐 | 몸(옷 밑 지움) | `namja_body_v19_under_coat.glb` | 9,986 |
| 남캐 | 몸(옷 밑 지움) | `namja_body_v19_under_denim.glb` | 9,986 |
| 남캐 | 몸(옷 밑 지움) | `namja_body_v19_under_garden.glb` | 9,986 |
| 남캐 | 몸(옷 밑 지움) | `namja_body_v19_under_lounge.glb` | 9,986 |
| 남캐 | 몸(옷 밑 지움) | `namja_body_v19_under_mbiker.glb` | 9,986 |
| 남캐 | 몸(옷 밑 지움) | `namja_body_v19_under_outfit2.glb` | 9,986 |
| 남캐 | 몸(옷 밑 지움) | `namja_body_v19_under_outfit3.glb` | 9,986 |
| 남캐 | 몸(옷 밑 지움) | `namja_body_v19_under_outfit4.glb` | 9,986 |
| 남캐 | 몸(옷 밑 지움) | `namja_body_v19_under_raincoat.glb` | 9,986 |
| 남캐 | 몸(옷 밑 지움) | `namja_body_v19_under_shirt1.glb` | 9,986 |
| 남캐 | 몸(옷 밑 지움) | `namja_body_v19_under_shirt6.glb` | 9,986 |
| 남캐 | 몸(옷 밑 지움) | `namja_body_v19_under_suit.glb` | 9,986 |
| 남캐 | 몸(옷 밑 지움) | `namja_body_v19_under_track.glb` | 9,986 |
| 남캐 | 몸(옷 밑 지움) | `namja_body_v19_under_trench.glb` | 9,986 |
| 남캐 | 몸(옷 밑 지움) | `namja_body_v19_under_turtle.glb` | 9,986 |
| 남캐 | 몸(옷 밑 지움) | `namja_body_v19_under_utility.glb` | 9,986 |
| 남캐 | 몸(옷 밑 지움) | `namja_body_v19_under_vest.glb` | 9,986 |
| 남캐 | 몸(옷 밑 지움) | `namja_body_v19_under_yellowhoodie.glb` | 9,986 |
