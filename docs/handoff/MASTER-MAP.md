...
★② ★★ 「했나」가 «셋»으로 흩어져 있다 — 퀘스트 done · coachSeen · fp.phase
   ⇒ 오늘 ①⑥ 을 고쳤지만 «뿌리»는 그대로다
③ 빈 화분(씨앗 심기)은 아직 «확인 화면»을 안 탄다
✔ coachMark 가 «봤다»만 적던 것          ⇒ 고침 (4642896) — 「기다리는 중」도 서랍에
✔ 아래글이 가이드 중에 「아무 데나」이던 것 ⇒ 고침 (56da8f3) — 「창턱 화분받침이 제일 밝습니다」
```

### ★★★ 오늘 닫힌 것 — 박사님 ⑥ **「가이드대로 안 하고 다음날 눌러도 가이드는 살아있게」**

```
앞 반쪽 「행동 안 해도」  ⇒ 아침 1e8c67b — 손가락이 「했나」를 «세이브»에서 본다(fp.phase)
뒤 반쪽 「살아있게」      ⇒ 저녁 4642896 — 못 «뜬» 쪽지가 «새로고침해도» 기다린다
```

⇒ ★ 눌러서 확인한 길: 화면을 바쁘게 하고 쪽지를 부름 → **새로고침** → 부팅에서 **조용해지자 실제로 떴다.**
⇒ ⚠ 「없는 쪽지 이름이 남은 옛 세이브」도 접게 했다 — **안 하면 물리는 자리.**
...
### ★ 그리고 하나 더 — **과녁이 작다** (아직 안 고쳤다)

```
방에 «선» 화분의 손가락 과녁  실측 «36 × 30» px   [폰 390×844 · 45일 그루 · 책상]
권장                                   «44 × 44»
```

**나흘짜리 끌기 건과 «다른 흠»이다** — 까닭이 다르고, 겪는 모양만 같다.

```
나흘짜리   「붙잡기가 풀려 «끌기»가 죽었다」        ⇒ ✔ 고쳤다
★ 과녁     「방에 «선» 화분을 «누르기»가 어렵다」   ⇒ ⛔ 그대로 남아 있다
⇒ 둘 다 사람에게는 「몬스테라가 손에 안 잡힌다」로 보인다
```

⇒ **지금은 덜 아프다** — ① 오늘 [옮기기] 손가락이 붙어 어디를 눌러야 할지 보이고,
② 가방에서 «눌러도» 확인 화면이 뜬다. ⇒ **막히기 전에 다른 길이 먼저 열린다.**
⇒ ⚠ 그래도 **방에 선 화분을 눌러 [옮기기]·[가방으로]를 쓰려면 그 과녁을 짚어야 한다.**
⇒ ★ 키우는 것은 **3D 집기라 판단이 필요해** 안 건드리고 두었다. (§7 ⑨)
