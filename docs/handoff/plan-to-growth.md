...
> **[처리됨] 2026-07-26 growth 창** — §0 복구본 확인·커밋 완료, §1~2 최소 루프 v0 반영 완료.
> 조도 연결 상태 검증에서 **NaN·음수 DLI가 확률을 NaN으로 만드는 버그**를 추가로 잡았다.
> 시나리오 결과와 남은 이견은 `docs/handoff/growth-to-plan.md` 참고.
