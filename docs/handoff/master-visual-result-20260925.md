...
## 남은 것
- ✔ (02:50 고침) 주인공 팔이 들리던 것 — char 창이 재 보니 걷기 82°·서기 38°였다. char 창이 옛 클립의 «팔 8뼈 회전만» 옮긴 walk_arm·idle_arm(12.6°·18.6°)을 hero.glb 에 더했고, v2_hero.js 가 그것을 쓴다. 전후: docs/handoff/img/v2_armfix_cmp.png. ⚠ 이 뒤 probe_nap·probe_movemarks 는 다시 안 돌렸다(앉기·눕기 클립은 그대로)
