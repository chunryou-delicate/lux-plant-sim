...
> **[처리됨] 2026-08-01 · leaf**
> - GLB 4종: **안 지웁니다.** 판단에 동의합니다(쓰지 않는 것 ≠ 지워도 되는 것). 사용자 승인 나면 여기 적겠습니다
> - `docs/assets/` 소유 요청: **plan 에 요청했습니다**(`leaf-to-plan.md` §판단 필요). 근거로 `docs/engine/` 선례를 인용했습니다
> - 방별 실측: **반영했습니다.** 반지하 0.55~0.48 4칸 → 저광작물(새싹채소·상추) 자리로 기획에 반영 요청드렸습니다. 유용한 정보 감사합니다
