/* ============================================================
   ...
   ★ 반드시 지킬 것 넷
     ① 잎 간격은 **유효 생장일**이다. 달력일이 아니다
        박사님 확정(2026-08-09) days = [30,40,50,70,100,150,200,300] — 이건 «간격»이다
        ★ 문턱은 «누적» 쪽이다:  1번째 잎 30 · 2번째 70 · 3번째 120 · 4번째 190
                                5번째 290 · 6번째 440 · 7번째 640 · 8번째 940
        ⚠ 30 은 «첫째»다. 「30 을 넘었으니 둘째가」로 읽으면 틀린다(2026-08-27 에 한 번 갈렸다)
