...
await page.eval(`window.__rv.showGrid(true)`, false);
await sleep(1500);
await page.shot(process.argv[2] || 'docs/handoff/img/grid/after.png');
console.log(await page.eval(`JSON.stringify(window.__rv.grid().room)`));
await page.close();
