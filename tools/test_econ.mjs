...
/* ══ F · ★질림은 한 표인가 — 표를 가르고 나서도 그 사상이 사나 ═════════════
   ...
   ⇒ 그래서 이 절이 이제 재는 것은 둘이다:
       ① 표(종류 축)가 배율을 그대로 따르나 — **예전 그대로**
       ② 그날 순번은 표를 **안 건드리나** — ★ 이번에 새로 지키는 것 */
check('F ★질림 배율은 한 표다 — 그 표를 읽는 축은 이제 **작물 종류** 하나다', () => {
