/* ============================================================
   ...
   무엇이 잘못돼 있었나.
     ...
     시루는 빠졌는데 심기지는 않았다 — 시루 하나가 **7,000원**인데 그냥 사라진다.

   ⚠ 값 정정(2026-08-09): 인계 문서와 커밋 `1da8e99` 에 「시루 14,000원」이라 적혀 있는데
     **틀렸다.** 정가 5,000원 × 웃돈 = `buyPriceOf('siru')` **7,000원**이 실제 지불액이다.
     앞 세션의 숫자를 확인 없이 옮긴 것이다. 버그와 고침 자체는 그대로 유효하다 —
     사라지던 금액이 두 배로 적혀 있었을 뿐이다.
