...
console.log('\n══ E  ★★ 회귀 — 화분 하나였던 판이 그대로인가 ═══════════════════════');
{
  ...
  const BEFORE = [
    ['bean_seed',    '콩 씨앗 (1시루분)',      500, 1,  700],
    ['monstera_seed', '몬스테라 씨앗 (1립)',   1500, 1, 2100],
    ['siru',         '콩나물 시루 (차광 용기)', 5000, 2, 7000],
  ...
  ok('E-6 손익분기가 그대로다 (씨앗값이 안 움직였다)',
     near(cropBreakEvenRate('beansprout'), 700 / 3000, 1e-12)
     && near(cropBreakEvenRate('musun'), 600 / 2000, 1e-12),
