  ...
  /* ★★ 2026-08-09 — **두 작물이 반대로 움직였다.**
     ...
     ★★ 2026-08-16 — **콩나물만 또 움직였다.** 박사님이 수확을 그램으로 정하셨다:
       *"중간빛에서 300G고 좀더 어두울수록 +-100G"* · 10원 = 1g.
       ...
       ★ 이 오름(+33%)은 **회귀가 아니라 박사님이 정하신 값**이다.

     ══ ⚠⚠ 2026-08-17 — **무순 쪽 줄이 뒤집혔다** (박사님 확정문 §1·§6) ═══════════
       옛 줄 — `near(cropBreakEvenRate('musun'), 600/1867)` = **32.1%**.
       두 가지가 겹쳐서 움직였다:
         ① 질림(둘째 작물 ×2/3)을 걷었다 — 「둘째 몫」 규칙이 대신한다(확정문 §6)
         ② 무순 수확량이 확정문 §1 의 **300 / 200 / 100g** 이 됐다(그램 표가 생겼다)
       ⇒ 최상 품질 한 회전분이 1,867 → **3,000원**이라 600/3,000 = **20.0%**.
