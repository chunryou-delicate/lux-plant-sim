...
/* ============================================================
   ...
   ★ 왜 무순인가 — **빛이 반대라서**다. 이것 하나가 고른 이유의 전부다.
     ...
     ⇒ 무순을 들이는 순간 **자리가 축이 된다.** "등보다 자리"가 식비에서도 산다.

     ══ ⚠⚠ 2026-08-24 정정 — **여기 있던 까닭이 틀렸었다** ══════════════════════════
     옛 줄은 *"밝은 자리를 몬스테라와 다툰다"* 였고 근거로 **DLI 1.0** 을 들었다.
     ★ **그건 몬스테라 문턱이다.** 무순 최상 문턱은 아래 `CROP_KINDS.musun` 의 **0.35** 다 —
       **셋 배 가까이 낮다.** 같은 자리에 적힌 `3.77` 도 낡았다(지금 `3.68`).
     ⇒ ★ 실측([Plan] 2026-08-24 · 맑음·여름·등 0개): 창턱(3.68)을 **빼고도**
       0.35 를 넘는 자리가 **정확히 다섯**이다 —
       desk:0 0.56 · etagere:6 0.51 · etagere:7 0.48 · etagere:8 0.48 · nightstand:0 0.44.
     ⇒ ⇒ **여름에는 안 다툰다.** 몬스테라는 창턱, 무순은 그 다섯. 자리가 갈린다.

     ★ **결론은 살아남고 까닭이 바뀐다 — 다투는 것이 아니라 「여유가 없다」다.**
       문턱 0.35 대비 여유가 창턱은 **열 배**인데 그 다섯은 **0.09~0.21** 뿐이다.
       ⇒ **계절이 조금만 깎으면 다섯이 한꺼번에 내려앉고 창턱만 남는다.**
         거기엔 몬스테라가 있다. **다툼은 그때 시작된다.**
     ⇒ 그래서 식물등에 **두 번째 이유**가 생기는 것도 맞다(지금은 몬스테라 전용이다) —
       다만 그 이유가 서는 때는 **여름이 아니라 계절이 돈 뒤**다.
     ⚠ 이 정정은 **값을 하나도 안 바꾼다.** 0.35 도 다섯도 원래 있던 것이고,
       **적혀 있던 까닭만 사실과 맞췄다.**
