...
;return {
  ...
  /* ★ 2026-09-07 ([growth] 청 · 385f2d4) — 「그 잎이 «어느 그림»을 쓰나」를 밖에서 «수로» 읽는 창구.
     원본(plant_grow §leafSkinUsedAll)이 이미 가진 함수를 그대로 낸다 — 여기에 로직 없음.
     ⚠ 두 칸으로 내는 까닭이 있다: 「고른 번호(matNum)」와 「지금 쓰는 열쇠(key)」가 다르다 —
